...
- **Cervical collar** — Cervical collar (颈托) model, STL + Rhino source
- **Left Knee Orthosis** — Left knee orthosis model, STL + Rhino source
- **Thoracolumbar Orthosis (TLO)** — Torso scan data, working files, and merged jacket model
- **Thoracumbar Orthosis V2** — Cervico-thoraco-lumbar orthosis, second iteration
...
- `.wrp` — Geomagic Wrap project files
